...
//     if ((type === "buy" && isBuyInvalid) || (type === "sell" && isSellInvalid)) return;
//     try {
...
//       onSuccess(`Congratulations! Coin ${type}ed successfully 🎉`, "success");
//       onClose();
//     } catch (err) {
  ...
  const confirmTrade = async () => {
    ...
    try {
      ...
      onSuccess((msg, status) => {
        fetchPortfolio(); // ✅ refresh portfolio after buy/sell
  ...
  return (
    <div className="bs-overlay">
      <div className="bs-modal">
        ...
        <p>Price: ${price}</p>
        <p>Balance: ${balance.toFixed(2)}</p>
        <p>Available Quantity: {ownedQty.toFixed(8)}</p>
